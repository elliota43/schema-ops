...
final class SQLiteGrammarTest extends TestCase
{
    ...
    #[Test]
    public function it_creates_tables_with_inline_primary_keys_and_constraints(): void
    {
        ...
        $table->addColumn($this->makeColumn('active', 'boolean', defaultValue: true));
        ...
        $this->assertStringContainsString('"active" BOOLEAN NOT NULL DEFAULT 1', $sql);
